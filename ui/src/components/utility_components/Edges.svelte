<script>
  ...
  // };
  let path = "";
  $: path = `M ${curr.left + 37 - left} ${curr.bottom - top + 5}
                C ${curr.left + 37 - left} ${curr.bottom - top + 50}, 
  ...
  $: line = {
    x1: curr.left + 37 - left,
    y1: curr.bottom - top + 5,
    x2: next.left + 37 - left,
    y2: next.top - top - 5,
  };
</script>
...
>
  <svg height="100%" width="100%" style="position: absolute; top: 0; left: 0; ">
    ...
    {#if !close}
      <path
        d={path}
        class="stroke-oli-500 stroke-[2px] fill-transparent active:stroke-red-400 hover:dark:stroke-neutral-200"
